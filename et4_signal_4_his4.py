...
def is_ichimoku_bullish(df: pd.DataFrame, idx: int, tol: float = 0.02) -> bool:
    """
...
def is_ichimoku_bearish(df: pd.DataFrame, idx: int, tol: float = 0.02) -> bool:
    """
