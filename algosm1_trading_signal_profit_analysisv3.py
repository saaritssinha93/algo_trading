...
TARGET_PCT: float = 5.0  # <-- change this once (e.g. 4.0, 5.0, 7.0, 10.0)
...
def build_signals_for_ticker(ticker: str) -> list[dict]:
    ...
    # IMPORTANT: shift weekly 'date' slightly forward so that on the
    # weekly bar's own calendar date, intraday bars still use the
    # previous week's weekly bar (no same-date lookahead).
