...
SIGNALS_DB = "generated_signals_historicaln1.json"
...
def detect_signals_in_memory(
    ...
    combined['StochDiff']   = combined['Stoch_%K'].diff()
    ...
    for idx_detect, row_detect in df_for_detection.iterrows():
        ...
        stoch_val   = combined.loc[cidx, 'Stoch_%K']
        ...
        if (check_bullish_breakout(daily_change, adx_val, price, high_10, vol, macd_val, roll_vol,
                                   macd_above_signal_now, stoch_val, stoch_diff, slope_bull, ich_bull, vwap, rsi)
        ...
        if (check_bearish_breakdown(daily_change, adx_val, price, low_10, vol, roll_vol, macd_val,
                                    macd_above_signal_now, stoch_val, stoch_diff, slope_bear, ich_bear, vwap, rsi)
