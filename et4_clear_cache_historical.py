# -*- coding: utf-8 -*-
"""
Created on Sun Feb  2 22:35:01 2025
...
MAIN_INDICATORS_DIR = "main_indicators_historical"  # Name of the main indicators directory
...
def clear_cache():
    ...
    Specifically targets both 'data_cache' and 'main_indicators_historical' directories.
    """
...
# Clear caches from both 'data_cache' and 'main_indicators_historical' directories
clear_cache()
