...
2) Run batched backtests (v6) with SL/TP logic and skip-if-results-exist.
...
PAPERTRADE_PREFIX     = "papertrade_5min_v6_"
RESULT_PREFIX         = "result_papertradesl_v6_"      # per-trade rows
RESULT_FINAL_PREFIX   = "result_finalsl_5min_v6_"      # per-day net % summary
...
BULL_STOP_LOSS_PCT = 0.02   # e.g., 3% below buy for bullish trades
BEAR_STOP_LOSS_PCT = 0.02   # e.g., 3% above sell for bearish trades
...
# Logging
logging.basicConfig(
    filename="trading_log_batched_v6.log",
    level=logging.INFO,
...
def process_multiple_dates(
    ...
    output_csv_path: str = "summary_5min_resultsv6.csv",
    pretty_csv_path: Optional[str] = "summary_5min_results_prettyv6.csv",
...
def run_cycle():
    ...
    # Backtest
    logging.info("Starting batched backtest (v6)…")
    ...
    process_multiple_dates(
        ...
        output_csv_path="summary_5min_resultsv6.csv",
        pretty_csv_path="summary_5min_results_prettyv6.csv",
        print_console=True
    )
