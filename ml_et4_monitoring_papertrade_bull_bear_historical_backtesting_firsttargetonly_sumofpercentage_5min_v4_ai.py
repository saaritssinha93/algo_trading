...
2) Run batched backtests (v4) with SL/TP logic and skip-if-results-exist.
...
PAPERTRADE_PREFIX     = "papertrade_5min_v4_"
RESULT_PREFIX         = "result_papertradesl_v4_"      # per-trade rows
RESULT_FINAL_PREFIX   = "result_finalsl_5min_v4_"      # per-day net % summary
...
# Logging
logging.basicConfig(
    filename="trading_log_batched_v4.log",
    level=logging.INFO,
...
def process_multiple_dates(
    ...
    output_csv_path: str = "summary_5min_resultsv4.csv",
    pretty_csv_path: Optional[str] = "summary_5min_results_prettyv4.csv",
...
def run_cycle():
    ...
    # Backtest
    logging.info("Starting batched backtest (v4)…")
    ...
    process_multiple_dates(
        ...
        output_csv_path="summary_5min_resultsv4.csv",
        pretty_csv_path="summary_5min_results_prettyv4.csv",
        print_console=True
    )
