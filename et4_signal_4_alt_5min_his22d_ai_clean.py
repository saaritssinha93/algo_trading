# -*- coding: utf-8 -*-
"""
Created on Mon Aug 25 22:04:08 2025
...
SIGNALS_DB     = "generated_signals_historical5minv6.json"
ENTRIES_DIR    = "main_indicators_history_entries_5minv6"
...
GLOBAL_MIN_PROB  = 0.50      # relaxed floor
GLOBAL_MAX_PROB  = 0.90     # relaxed ceiling
...
file_handler = TimedRotatingFileHandler(
    "logs\\signalnewn5minv6.log", when="M", interval=30, backupCount=5, delay=True
)
...
def detect_signals_in_memory(
    ...
    debug: bool = False,
    volrel_gate_min: float = 1.1,    # relaxed
