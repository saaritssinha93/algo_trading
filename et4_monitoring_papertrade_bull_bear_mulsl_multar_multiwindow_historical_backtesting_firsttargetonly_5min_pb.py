# -*- coding: utf-8 -*-
"""
Created on Mon Aug 25 21:39:40 2025

@author: Saarit

Combined runner:
1) Normalize Quantity & Total value in papertrade files.
2) Run batched backtests (pb) with SL/TP logic and skip-if-results-exist.
...
PAPERTRADE_PREFIX     = "papertrade_5min_pb_"
RESULT_PREFIX         = "result_papertradesl_pb_"      # per-trade rows
RESULT_FINAL_PREFIX   = "result_finalsl_5min_pb_"      # per-day net % summary
...
# Trade params
BULL_TARGET_PCT = 0.01
BEAR_TARGET_PCT = 0.01
STOP_LOSS_PCT   = 0.02
...
# Logging
logging.basicConfig(
    filename="trading_log_batched_pb.log",
    level=logging.INFO,
...
def process_multiple_dates(
    ...
    output_csv_path: str = "summary_5min_resultspb.csv",
    pretty_csv_path: Optional[str] = "summary_5min_results_prettypb.csv",
...
def run_cycle():
    ...
    # Backtest
    logging.info("Starting batched backtest (pb)…")
    ...
    process_multiple_dates(
        ...
        output_csv_path="summary_5min_resultspb.csv",
        pretty_csv_path="summary_5min_results_prettypb.csv",
        print_console=True
    )
