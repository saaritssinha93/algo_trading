...
2) Run batched backtests (v2) with SL/TP logic and skip-if-results-exist.
...
PAPERTRADE_PREFIX     = "papertrade_5min_v2_"
RESULT_PREFIX         = "result_papertradesl_v2_"      # per-trade rows
RESULT_FINAL_PREFIX   = "result_finalsl_5min_v2_"      # per-day net % summary
...
# Logging
logging.basicConfig(
    filename="trading_log_batched_v2.log",
    level=logging.INFO,
...
def process_multiple_dates(
    ...
    output_csv_path: str = "summary_5min_resultsv2.csv",
    pretty_csv_path: Optional[str] = "summary_5min_results_prettyv2.csv",
...
def run_cycle():
    ...
    # Backtest
    logging.info("Starting batched backtest (v2)…")
