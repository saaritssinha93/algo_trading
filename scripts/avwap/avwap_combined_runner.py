...
_project_root = _this_dir.parent.parent  # scripts/avwap/ -> scripts/ -> project_root
...
def _resolve_5min_dir() -> Path:
    ...
    if _script_dir.name == "avwap_v11_refactored":
        ...
        # Running from scripts/avwap/ — project root is two levels up
        _proj = _script_dir.parent.parent
