...
Inputs (directories follow your existing scripts):
    • 1H data per ticker    : main_indicators_etf_1h/<TICKER>_main_indicators_etf_1h.csv
    • Daily data per ticker : main_indicators_etf_daily/<TICKER>_main_indicators_etf_daily.csv
    • Weekly data per ticker: main_indicators_etf_weekly/<TICKER>_main_indicators_etf_weekly.csv
...
TARGET_PCT: float = 6.0  # <-- change this once (e.g. 4.0, 5.0, 7.0, 10.0)
